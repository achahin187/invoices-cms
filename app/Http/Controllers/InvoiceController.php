...
class InvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('invoices.invoice', compact('invoices','details'));
    }
...
///store invoice to table-invoices
        ...
        /////messages
        toastr()->success('تم اضافه المنتج بنجاح');
        ///////////
...
/////////////change payment status and update
    ...
    public function destroy($id)
    {
       ...
       if($invoices != null){
            $invoices->delete();
                toastr()->success('تم ارشفه الفاتوره بنجاح!');
