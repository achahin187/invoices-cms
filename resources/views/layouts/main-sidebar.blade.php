				...
				<ul class="side-menu">
					...
					<ul  class="collapse" id="collapseExample1">
						@can('قائمة الفواتير')
							...
							<li class="list-group"><a class="card-title" href="{{ url('Invoice_Paid') }}">الفواتير المدفوعه</a></li>
							@endcan
							@can( 'الفواتير الغير مدفوعة')
							<li class="list-group"><a class="card-title" href="{{ url('Invoice_UnPaid') }}">الفواتير الغير مدفوعه</a></li>
							@endcan
							@can('الفواتير المدفوعة جزئيا')
							<li class="list-group"><a class="card-title" href="{{ url('Invoice_Partial') }}">الفواتير المدفوعه جزئيا</a></li>
							@endcan
							@can( 'ارشيف الفواتير')
							<li class="list-group"><a class="card-title" href="{{ url('Archive') }}">ارشيف الفواتير</a></li>
							@endcan
					</ul>
					</li>
					@endcan
...
@can(  'التقارير')
					...
					<li class="slide">
						...
						<ul class="collapse" id="collapseExample2">
							@can( 'تقرير الفواتير')
							<li class="list-group"><a class="card-title" href="{{ url('/' . $page='alerts') }}">تقرير الفواتير </a></li>
							@endcan
							@can('تقرير العملاء')
							<li class="list-group"><a class="card-title" href="{{ url('/' . $page='avatar') }}">تقرير العملاء</a></li>
							@endcan
				...
				@can( 'المستخدمين')
					...
					<li class="slide">
						...
						<ul  class="collapse" id="collapseExample3">
							...
							<li class="list-group" ><a class="card-title" href="{{ route('users.index')}}">قائمه المستخدمين</a></li>
							@endcan
							@can('صلاحيات المستخدمين')
							<li class="list-group"><a class="card-title" href="{{ route('roles.index') }}">صلاحيات المستخدمين</a></li>
							@endcan
